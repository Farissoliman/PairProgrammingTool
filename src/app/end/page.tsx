...
export default function Page() {
  ...
  const totalExpressions = nonVerbalExpressions + userUtterances;
        ...
        <div>
          ...
          <div className="flex pt-4">
            <div className="flex-1 text-xl">
              ...
              <p className="text-sm mt-3">
                Verbal communication represents the number of utterances spoken by you.
                Non-Verbal represents the number of facial expressions made by you.
              </p>
            </div>
            <div className="flex-2">Pie Chart Goes Here</div>
          </div>
          <div className="flex pt-4">
            <div className="flex-1 text-xl">
              ...
              <p className="text-sm mt-3">
                Number of times you interrupted your partner as a percentage of total interruptions
              </p>
            </div>
            <div className="flex-2">Pie Chart Goes Here</div>
          </div>
